...
当前版本 **1.6.2**：四个任务区串起想法、方案比较、材料准备、制作与成品记录。新建首屏即可开始，明确排除材料、配色与数字数量可核对；图片归属作品并标记旧设计版本，支持含图片导出、材料替换、采购、实耗撤销与快照恢复。IndexedDB v2 原位升级保留旧作品，图片和作品原子提交；继续保留既有模块化与格式兼容能力。
