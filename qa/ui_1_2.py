...
report={'version':'1.2.0','checks':len(checks),'items':checks,'screenshots':37,'desktop':19,'mobile':18,'note':'Screenshots are primary page-by-page visual acceptance inputs. Contact sheet is intentionally not generated by this gate.'}
(QA/'ui-1.2.json').write_text(json.dumps(report,ensure_ascii=False,indent=2))
print(f"ui-1.2: {len(checks)} checks passed; 37 page screenshots written")
