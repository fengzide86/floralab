...
ok(app.includes('Workflow.restore()'),'app restores through storage module');
...
ok(createView.includes('整理想法，查看方案'),'Create CTA explains the next result');
...
ok(app.includes("['explore','比较方向']"),'Direction workspace is in project tabs');
