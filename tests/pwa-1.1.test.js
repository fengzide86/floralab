...
let installed=null,activated=null,fetchHandler=null,added=[],networkCalls=[];const cacheStore=new Map();
...
const ctx={
 ...
 Request:class extends Request{constructor(url,options){super(new URL(url,'https://example.com/floralab/'),options);}},URL,
 fetch:async(req,options)=>{networkCalls.push({req,options});return {status:200,type:'basic',clone(){return this;}};},Promise,console,setTimeout,clearTimeout
};
